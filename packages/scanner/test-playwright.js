...
console.log('Testing Playwright launching from packages/scanner...');
...
async function test() {
  ...
  console.log('4. Page created. Navigating to https://yournextoutfits.com/...');
  
  await page.goto('https://yournextoutfits.com/', {
    waitUntil: 'load',
    timeout: 10000,
  });
